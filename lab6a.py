...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number) # Solve 1st problem of integer input studen number so add str() to ensure the input pass.
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0: # Solve 2nd problem that no courses added 
